...
def main(input_file1, input_file2, output_file, columns_to_compare):
    ...
    generate_comparison_report("Unaggregated TSV", id_format, differences, unique_variants, comparer.input_file1, comparer.input_file2, comparer.output_path, columns_dropped_message, differences_summary)
