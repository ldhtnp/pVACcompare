...
def main(input_file1, input_file2, output_file):
    ...
    generate_comparison_report("Unaggregated TSV", differences, unique_variants, comparer.input_file1, comparer.input_file2, comparer.output_path, columns_dropped_message)
