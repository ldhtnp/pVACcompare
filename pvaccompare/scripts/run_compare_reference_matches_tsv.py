...
def main(input_file1, input_file2, output_file):
    ...
    differences, unique_variants = get_file_differences(comparer.df1, comparer.df2, comparer.columns_to_compare, comparer.unique_variants_file1, comparer.unique_variants_file2)
    generate_comparison_report("Reference Match TSV", differences, unique_variants, comparer.input_file1, comparer.input_file2, comparer.output_path, columns_dropped_message)
